...
<link rel="stylesheet" type="text/css" href="{{ asset('qt64_user/assets/font/font-awesome.min.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('qt64_user/assets/font/font.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('qt64_user/assets/css/bootstrap.min.css') }}" media="screen" />
<link rel="stylesheet" type="text/css" href="{{ asset('qt64_user/assets/css/style.css') }}" media="screen" />
<link rel="stylesheet" type="text/css" href="{{ asset('qt64_user/assets/css/responsive.css') }}" media="screen" />
<link rel="stylesheet" type="text/css" href="{{ asset('qt64_user/assets/css/jquery.bxslider.css') }}" media="screen" />
</head>
<body>
...
<script type="text/javascript" src="{{ asset('qt64_user/assets/js/jquery-min.js')}}"></script> 
<script type="text/javascript" src="{{ asset('qt64_user/assets/js/bootstrap.min.js')}}"></script> 
<script type="text/javascript" src="{{ asset('qt64_user/assets/js/jquery.bxslider.js')}}"></script> 
<script type="text/javascript" src="{{ asset('qt64_user/assets/js/selectnav.min.js')}}"></script> 
